...
function Footer() {
  return (
    <footer className="container-fluid bg-white pt-5 pb-5" style={{borderTop:'1px solid #C8C8C8 '}}>
      <div className="main_container pt-12 pb-10 wrapper-border1">
        <div className="row gy-6 gy-lg-0">
          <div className="col-md-4 col-lg-3">
            <div className="widget d-flex justify-content-center justify-content-md-start">
